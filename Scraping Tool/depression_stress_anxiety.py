...
#"depression" apps
driver.get("https://play.google.com/store/search?q=depression%20stress%20anxiety&c=apps")
...
download_dir = "example6-1.csv" #where you want the file to be downloaded to 
